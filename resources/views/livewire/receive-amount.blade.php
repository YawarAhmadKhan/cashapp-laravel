                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 row">
                        <div class="col-lg-3">
                            ...
                            <p class="text-muted"> Total Amount Sent <span class="text-bold text-danger">${{$Receive}}</span></p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                            <div class="w-full overflow-x-auto table-responsive">
                              ...
                              {{ $totalreceive->links(data: ['scrollTo' => false])}}
                            </div>
                          </div>
