            ...
            <div class="col-md-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 row">
                        <div class="col-lg-3">
                            <h6 class="m-0 font-weight-bold text-primary">Sent Amount List</h6>
                            <p class="text-muted"> Total Amount Sent <span class="text-bold text-danger">${{$SentAmount}}</span></p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                            <div class="w-full overflow-x-auto table-responsive">
                              <table class="w-full whitespace-no-wrap table-hover">
                                <thead>
                                  <tr
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @forelse ($TotalSentTransactions as $item)
                              ...
                              {{ $TotalSentTransactions->links(data: ['scrollTo' => false])}}
                            </div>
                          </div>
