    ...
    if(!response.result.messages){
      ...
      return;
              ...
              const messages = response.result.messages;
                ...
                var dataArray = [emailData, emailId];
                var url = "/home_savng_1234";
                $.ajax({
    type: "POST",
    url: url,
    data: { dataArray: JSON.stringify(dataArray) }, // Send data as JSON string
    success: function(response) {
        // Handle success response
        console.log("Data sent successfully!");
        console.log(response); // If your backend returns any response
    },
