            ...
            <div class="col-md-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <div>
                         <h6 class="m-0 font-weight-bold text-primary">Refunded Amount List</h6>
                        <p class="text-muted"> Total Refunds <span class="text-bold text-danger    ">${{$cashRefunded}}</span></p>
                        </div>
